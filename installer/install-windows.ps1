...
#   powershell -ExecutionPolicy Bypass -Command "$f=\"$env:TEMP\install-windows.ps1\"; irm https://raw.githubusercontent.com/marcosmmjr2023/dsh-h-v1/main/installer/install-windows.ps1 -Headers @{'Cache-Control'='no-cache'} -OutFile $f; & $f"
