# FreeDSH Community Documentation

Use these documents together:

- [CONTRIBUTING.md](../CONTRIBUTING.md) — how to contribute.
- [ROADMAP.md](../ROADMAP.md) — public priorities.
- [ARCHITECTURE.md](ARCHITECTURE.md) — contributor architecture map.
- [COMMUNITY-LAUNCH.md](COMMUNITY-LAUNCH.md) — 30-day community-growth playbook.
- [PROMOTION-KIT.md](PROMOTION-KIT.md) — ready-to-adapt launch copy.
